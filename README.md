...
This was a project mainly to showcase my html & css skills. I decided to make probably one of the most used sites ever, Google! This was the first project I created when I was first learning these beginner technologies. Plans are to implement new features that increase overall performance and functionality, while still maintaining that beautiful, minimlist design esthetic that we've come to love Google for!

Initially appeared on [GitHub (repo)](https://github.com/harlanray/GoogleV2).
...
We use [Semantic Versioning](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/harlanray/GoogleV2/releases).
